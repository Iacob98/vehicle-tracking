-- Migration 024: Исправление RLS политик с CASCADE
-- Удаляем функции И все зависящие от них политики, потом создаём всё заново

-- =============================================
-- Удаляем старые функции с CASCADE (удалит и все политики)
-- =============================================
